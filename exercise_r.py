...
def start_voice_agent_call(to_number: str, start_message: str, pain_profile: str) -> str:
    """
    ...
    payload = {
        ...
        "conversation_initiation_client_data": 
        {
            ...
            "dynamic_variables": {
                # Dynamic variables are simple types (string/number/bool).
                # If you have structured data, JSON-serialize it first.
...
def main():
    ...
    start_voice_agent_call("+18312871621", "Hello this is Jess from Soma AI calling to check in on your pain levels today.", "leg pain after soccer, severity 2, sharp pain started 3 days ago")
